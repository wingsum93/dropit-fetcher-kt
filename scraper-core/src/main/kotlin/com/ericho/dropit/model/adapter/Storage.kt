...
interface Storage : AutoCloseable {
    ...
    fun findProducts(limit: Int = 100): List<ProductEntity>
    ...
    fun findJobsBySync(syncId: Int, status: JobStatus? = null, type: JobType? = null): List<JobEntity>
    fun claimPendingJobs(limit: Int): List<JobEntity>
    ...
    fun findSyncById(id: Int): SyncEntity?
    fun createSyncEntity(): SyncEntity
    fun updateSyncEntity(entity: SyncEntity): SyncEntity
    fun updateSyncStatusFromJobs(syncId: Int): SyncEntity?
    fun reserveRateLimitSlot(name: String, spacingMs: Long): Instant
